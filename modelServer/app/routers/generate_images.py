...
def create_generated_images(items: List[exampleItem], common_image: str) -> List[generatedItem]:
    """ 
...
async def generate_images(request: PromptRequestDto) -> GeneratedImageResponseDto:
    ...
    data = create_generated_images(request.exampleItems, request.exampleImage)
